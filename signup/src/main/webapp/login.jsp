...
<body>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="container">
                    ...
                    <form method="POST" action="login">
                        ...
                        <br>
                        <button class=" btn btn-primary shadow d-block w-10 " type="send ">Submit</button>
                    </form>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js " integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIeXgFb2XdBhDXTt2N0N9P0y2aaCfhOK4uHLYaZOI7wT " crossorigin="anonymous "></script>
    ...
    <footer class="footer">
        <div class="text-muted d-flex justify-content-between align-items-center pt-3 ">
            <p class="mb-0 "><a class="navbar-brand d-flex align-items-center " href="/ "><span class="pulse animated infinite ">Infocom © 2022 Brand</span></a></p>
